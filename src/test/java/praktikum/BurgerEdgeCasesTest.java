...
public class BurgerEdgeCasesTest {
    ...
    @Test
    public void testMultipleAddOperationsIncreaseSize() {
        burger.setBuns(mockBun);
    ...
    @Test
    public void testPriceAfterRemoveIngredient() {
        burger.setBuns(mockBun);
    ...
    public void testMoveIngredientInvalidIndex() {
        ...
        burger.moveIngredient(0, invalidNewIndex);
    }

    @Test
    public void testEmptyBurgerReceiptIsNotNull() {
        burger.setBuns(mockBun);
    ...
    @Test
    public void testEmptyBurgerReceiptHasCorrectNumberOfLines() {
        burger.setBuns(mockBun);
    ...
    @Test
    public void testEmptyBurgerReceiptFirstLineFormat() {
        burger.setBuns(mockBun);
    ...
    @Test
    public void testEmptyBurgerReceiptSecondLineFormat() {
        burger.setBuns(mockBun);
    ...
    @Test
    public void testEmptyBurgerReceiptThirdLineIsEmpty() {
        burger.setBuns(mockBun);
    ...
    @Test
    public void testEmptyBurgerReceiptPriceLineFormat() {
        burger.setBuns(mockBun);

        String receipt = burger.getReceipt();
        String[] lines = receipt.split("\n");
        
        assertEquals("Четвертая строка должна содержать правильную цену", 
